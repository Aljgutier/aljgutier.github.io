...
In this article we study a state-of-the-art predictive analytics pipeline for structured data. Structured data represents the most common data format in the industry. Structured data, is also known as "tabular data," and is commonly hosted in a relational database. It is well-known that deep learning has achieved significant breakthroughs for computer vision and NLP, achieving human-like performance. However, it is not as widely known that deep learning, with the use of entity embeddings, can provide significant predictive performance relative to traditional machine learning approaches for structured data. Entity Embeddings empower Deep Learning to achieve a significant predictive performance improvement, [Fastai Categorical Embeddings](https://www.fast.ai/2018/04/29/categorical-embeddings/). Below, we walk through the Python code based on the [Fastai](https://www.fast.ai/) library and demonstrate how to set up a predictive analytics pipeline based on deep learning with embeddings. We utilize the Kaggle, Rossmann dataset, discuss the deep-learning architecture, training, performance, and compare the predictive performance to a machine learning tree-based model. 
