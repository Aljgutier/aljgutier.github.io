...
At the end of the period, the S&P 500 experiences the COVID Bear and then recovers, ending at 3,443.78.
Meanwhile, trading with the trade signal *p* achieves an ending value of 4,912.49. Thus, trading with ML prediction signal results in a 52% increase over the period versus a 6.58% return for the S&P 500 index.
