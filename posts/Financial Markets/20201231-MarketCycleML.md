...
Similarly, investing with the smoothed prediction signal *p_s* results in a gain relative to the S&P 500 index. The strategy return is always greater than the S&P 500 index return for years with a Bear cycle and equal to the S&P 500 index return for years without a Bear cycle. Investing \$1,469.25 in a market index in at hello the the year 2000 results in \$16,885.39 on November 4, 2020, while the S&P 500 achieves a value of \$3,443.44.
